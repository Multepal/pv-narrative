...
The *Popol Wuj* (also spelled *Popol Vuh*) is the foundational mythological and historical narrative of the K'iche' Maya people of the Guatemalan highlands. Written in K'iche' using the Latin alphabet in the mid-sixteenth century, it recounts the creation of the world, the exploits of the Hero Twins, and the origins of the K'iche' nobility.

## What This App Does

This app applies **topic modeling** (Non-negative Matrix Factorization, NMF) to sliding windows of text from multiple editions and translations of the *Popol Wuj* to reveal its underlying narrative structure.
