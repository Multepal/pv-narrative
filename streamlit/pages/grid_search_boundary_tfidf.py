"""
Parameter Grid Search — Boundary Concordance (TF-IDF/HAC) — sweep combinations of
...
Pipeline: raw TF-IDF (no SVD) → pdist(euclidean) → Ward HAC → fcluster.
k is swept cheaply post-linkage (fcluster only). TF-IDF+linkage runs are cached.
"""
...
st.caption(
    ...
    "k is swept cheaply post-linkage; TF-IDF+linkage results are cached."
)
