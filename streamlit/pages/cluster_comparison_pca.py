"""
Cross-Edition Cluster Comparison (PCA/LSA) — same as cluster_comparison.py but
inserts TruncatedSVD (n_components=10) between TF-IDF and HAC.
"""
...
# ── Controls ──────────────────────────────────────────────────────────────────
st.title("Cross-Edition Comparison — PCA/LSA")
render_toc([
    ("Agreement vs. Parameter",    "agreement-chart"),
    ("Pairwise Distance Matrices", "pairwise-matrices"),
])
st.caption(
    f"Same as Cross-Edition Comparison but uses TF-IDF → LSA (TruncatedSVD, "
